...
export function ProjectCard({ project }: { project: Project }) {
  return (
    <Link
      ...
      className="group block rounded-[2rem] border border-border/80 bg-white/88 p-6 shadow-[0_18px_50px_rgba(15,23,42,0.04)] transition duration-200 hover:-translate-y-1 hover:shadow-[0_24px_70px_rgba(15,23,42,0.08)]"
    >
