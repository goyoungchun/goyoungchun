...
export default function AboutPage() {
  return (
    <main>
      ...
      <section className="pb-8"><Container><SectionHeading title="What this studio is building" description="생활 밀착형 디지털 제품을 만들며, 사용자 경험과 보안, 신뢰를 가장 중요한 기준으로 삼습니다." /><div className="max-w-prose space-y-4 text-base leading-7 text-muted"><p>이 스튜디오는 일상 속에서 떠오르는 아이디어를 실제 제품으로 구현하고, 그 결과물이 사람들의 생활 안에서 자연스럽게 쓰이도록 만드는 것을 목표로 합니다.</p><p>기술이 빠르게 발전할수록 오히려 불편한 공백도 함께 생긴다고 생각합니다. 저는 그 공백을 발견하고, 작지만 실제로 쓸 수 있는 앱으로 연결하는 작업에 집중합니다.</p><p>지금은 디아리오를 중심으로, 기록을 더 쉽게 시작하게 만들고 쌓인 기록을 다시 돌아보게 만드는 경험을 다듬고 있습니다.</p><p>제품을 만들 때는 사용자 경험을 가장 먼저 생각하고, 그 위에 보안과 높은 신뢰도를 단단하게 쌓는 방식을 지향합니다.</p></div></Container></section>
      <SiteFooter />
    </main>
  )
}
